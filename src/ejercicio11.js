window.onload = function() {
  ...
  var mensaje = "<br/>Numero de enlaces = " + enlaces.length
  info.innerHTML = info.innerHTML + mensaje;
  // vemos valores en console.log
  console.log({enlaces});
  console.log(enlaces.length);

  // Direccion del penultimo enlace
  mensaje = "<br/>" + "El penultimo enlace apunta a: " + enlaces[enlaces.length - 2].href;
  info.innerHTML = info.innerHTML + mensaje;
  ...
  var enlaces3erP = parrafos[3].getElementsByTagName("a");
